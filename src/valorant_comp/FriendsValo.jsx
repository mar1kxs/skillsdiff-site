...
import "../styles/frnds-trn-valo.css";

const WithFriendsValo = () => {
  return (
    <section className="frnds-trn">
      <h3>
        Тренировки с <span style={{ color: "#FF4350" }}>друзьями</span>
      </h3>
      <ul className="frnds-list">
        <li className="frnds-card">
          <div className="frnds-card-header">
            <h4>2 человека</h4>
            <p className="valo-p">1 тренировка</p>
...
export default WithFriendsValo;
